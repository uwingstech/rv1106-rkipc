...
//  input bytes */ #define MBEDTLS_HMAC_DRBG_MAX_REQUEST        1024 /**< Maximum number of
//  requested bytes per call */ #define MBEDTLS_HMAC_DRBG_MAX_SEED_INPUT      384 /**< Maximum size
//  of (re)seed buffer */
...
//  bytes required for the hardware entropy source mbedtls_hardware_poll() before entropy is
//  released
//*/
...
//  MBEDTLS_PLATFORM_STD_NV_SEED_WRITE  mbedtls_platform_std_nv_seed_write /**< Default
//  nv_seed_write function to use, can be undefined */ #define MBEDTLS_PLATFORM_STD_NV_SEED_FILE
//  "seedfile" /**< Seed file to read/write with default implementation */
...
//  to use, can be undefined */ #define MBEDTLS_PLATFORM_TIME_MACRO            time /**< Default
//  time macro to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */ #define
...
//  enabled) */ #define MBEDTLS_PSK_MAX_LEN               32 /**< Max size of TLS pre-shared keys,
//  in bytes (default 256 bits) */ #define MBEDTLS_SSL_COOKIE_TIMEOUT        60 /**< Default
//  expiration delay of DTLS cookies, in seconds if HAVE_TIME, or in number of cookies issued */
